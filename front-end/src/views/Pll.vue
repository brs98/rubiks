<template>
  <div class="Pll">
    ...
    <PllList :algorithms="algorithms" />
  </div>
</template>

<script>
  import PllList from '../components/PllList.vue';
  export default {
    name: "Pll",
    components: {
      PllList
    ...
    computed: {
      algorithms() {
        return this.$root.$data.PllAlgorithms.filter(algorithm => algorithm.category === this.selection)
      }
    },
    methods: {
      select(selection) {
